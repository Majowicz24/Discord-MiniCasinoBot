...
async def LRC(ctx, p1 : discord.Member, p2 : discord.Member, p3 : discord.Member, p4 : discord.Member):
    global player1
    global player2
    global player3
    global player4
...
async def roll(ctx):
    ...
    if not gameOver:
        ...
        if turn == ctx.author:
            ...
            if chipsp1 == 0 and chipsp2 == 0 and chipsp3 == 0:
                gameOver = True
            ...
            elif chipsp2 == 0 and chipsp3 == 0 and chipsp4 == 0: 
                gameOver = True
                await ctx.send("Congratulations, <@" + str(player1.id) + ">, you win!.")
                await ctx.send("Please use **-reset** to return to the menu and start a new game.")
            elif chipsp3 == 0 and chipsp4 == 0 and chipsp1 == 0:
                gameOver = True
                await ctx.send("Congratulations, <@" + str(player2.id) + ">, you win!.")
                await ctx.send("Please use **-reset** to return to the menu and start a new game.")
            elif chipsp4 == 0 and chipsp1 == 0 and chipsp2 == 0:
                gameOver = True
